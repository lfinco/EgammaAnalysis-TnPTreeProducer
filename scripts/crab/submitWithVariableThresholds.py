...
if __name__ == '__main__':
  ...
  def submit(config, sample, leg1threshold, leg2threshold, json):
    ...
    config.JobType.pyCfgParams  = defaultArgs + ['L1Threshold=%s' % leg1threshold]#, 'leg2Threshold=%s' % 0]
  ...
  for leg1, leg2, json in getSeedsForDoubleEle('2016'):
    ...
    submitWrapper(config,'/SingleElectron/Run2016B-07Aug17_ver2-v2/MINIAOD', leg1, leg2, json)
    submitWrapper(config,'/SingleElectron/Run2016C-07Aug17-v1/MINIAOD', leg1, leg2, json)
    submitWrapper(config,'/SingleElectron/Run2016D-07Aug17-v1/MINIAOD', leg1, leg2, json)
    submitWrapper(config,'/SingleElectron/Run2016E-07Aug17-v1/MINIAOD', leg1, leg2, json)
    submitWrapper(config,'/SingleElectron/Run2016F-07Aug17-v1/MINIAOD', leg1, leg2, json)
    submitWrapper(config,'/SingleElectron/Run2016G-07Aug17-v1/MINIAOD', leg1, leg2, json)
    submitWrapper(config,'/SingleElectron/Run2016H-07Aug17-v1/MINIAOD', leg1, leg2, json)
