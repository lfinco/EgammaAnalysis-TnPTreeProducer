...
def setTagsProbes(process, options):
    ...
    setattr(process,  "passHltEle32DoubleEGWPTightGsf", process.probeElePassHLT.clone(filterNames=cms.vstring("hltEle32L1DoubleEGWPTightGsfTrackIsoFilter")))
    setattr(process,  "passEGL1SingleEGOr", process.probeElePassHLT.clone(filterNames=cms.vstring("hltEGL1SingleEGOrFilter")))
