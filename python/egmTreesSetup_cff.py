...
def setTagsProbes(process, options):
    ...
    # if options['isMC']:
    #     hltObjects     = 'slimmedPatTrigger' #FOR MC 2016
    # else:
    #     hltObjects     = 'selectedPatTrigger' #FOR data 2016
    hltObjects     = 'selectedPatTrigger' #FOR data 2016
    ...
    setattr(process,  "passHltEle27WPTightGsf", process.probeElePassHLT.clone(filterNames=cms.vstring("hltEle27WPTightGsfTrackIsoFilter")))
    ...
    setattr(process,  "passHltDoubleEle33CaloIdLMWSeedLeg", process.probeElePassHLT.clone(filterNames=cms.vstring("hltEG33CaloIdLMWPMS2Filter")))
    setattr(process,  "passHltDoubleEle33CaloIdLMWSeedLegL1match", process.probeElePassHLTL1matched.clone(filterNames=cms.vstring("hltEG33CaloIdLMWPMS2Filter")))
